...
class HICODetection(torch.utils.data.Dataset):
    def __init__(self, vis_processors, txt_processors, img_set, img_folder, anno_file, clip_feats_folder, transforms, num_queries, args):
    ...
    def __getitem__(self, idx):
        ...
        # if self.img_set == 'train':
        #     caption_gpt = "##".join(self.captions[img_anno['file_name']]['hoi'])
        # else:
...
def build(vis_processors, txt_processors, image_set, args):
    ...
    dataset = HICODetection(vis_processors, txt_processors, image_set, img_folder, anno_file, clip_feats_folder,
